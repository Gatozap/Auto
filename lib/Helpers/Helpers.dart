...
import 'Helper.dart';
const Color vermelho = Color.fromARGB(255, 123, 97,168);
...
Widget defaultCheckBox(bool isChecked, text, context, onTap, {color: vermelho,size }) {
...
InputDecoration DefaultInputDecoration(
    context, {
      ...
      hintColor= vermelho,
      error,
      var labelText, borderColor = vermelho,
    }) {
  double fontsize = 14;
...
Widget defaultActionButton(String text, context, Function onPressed,
    {var icon = Icons.add,color = vermelho, textColor = Colors.white,int size= 20, double sizei = 30.0,double elevation=10}) {
  return Padding(
    padding: const EdgeInsets.all(8.0),
    child: MaterialButton(elevation: elevation,
