...
class Carro {
  ...
  Carro.fromJson(j)
      : cor = j['cor'],
        ...
        modelo = j['modelo'],
        marca = j['marca'],
        is_anuncio_bancos=j['is_anuncio_bancos']== null? false: j['is_anuncio_bancos'],
        is_anuncio_laterais=j['is_anuncio_laterais']== null? false: j['is_anuncio_laterais'],
  is_anuncio_vidro_traseiro=j['is_anuncio_vidro_traseiro']== null? false: j['is_anuncio_vidro_traseiro'],
  is_anuncio_traseira_completa=j['is_anuncio_traseira_completa']== null? false: j['is_anuncio_traseira_completa'],
        placa = j['placa'],
  ...
  Map<String, dynamic> toJson() => {
        ...
        'marca': marca,
        'placa': placa,
    'is_anuncio_bancos': is_anuncio_bancos == null? false: is_anuncio_bancos,
    'is_anuncio_laterais': is_anuncio_laterais == null? false: is_anuncio_laterais,
    'is_anuncio_vidro_traseiro': is_anuncio_vidro_traseiro == null? false: is_anuncio_vidro_traseiro,
    'is_anuncio_traseira_completa': is_anuncio_traseira_completa == null? false: is_anuncio_traseira_completa,
        'dono_nome': dono_nome,
