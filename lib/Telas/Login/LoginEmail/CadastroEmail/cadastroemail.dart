...
class _CadastroEmailState extends State<CadastroEmail> {
  ...
  @override
  void initState() {
    createFileOfPdfUrl("https://avanticar-34239.web.app/politica.pdf").then((f) {
      setState(() {
        pathPDF = f.path;
        print(pathPDF);
      });
    ...
    createFileOfPdfUrl("https://avanticar-34239.web.app/termos.pdf").then((f) {
      setState(() {
        TermospathPDF = f.path;
        print(pathPDF);
      });
    });
    super.initState();
                                  ...
                                  children: [
                                        ...
                                        recognizer: new TapGestureRecognizer()
                                          ..onTap = () {
                                            Navigator.of(context).push(
                                              MaterialPageRoute(builder: (context) => PDFViewerScaffold(appBar: myAppBar('Termos de Uso', context,showBack: true),path: TermospathPDF)),);
                                          },
                                        style: TextStyle(
                                    ...
                                    TextSpan(
                                        ...
                                        recognizer: new TapGestureRecognizer()
                                          ..onTap = () {
                                            Navigator.of(context).push(
                                              MaterialPageRoute(builder: (context) => PDFViewerScaffold(appBar: myAppBar('Política de Privacidade', context,showBack: true),path: pathPDF)),);
                                          },
                                        style: TextStyle(
                                            color: Colors.yellowAccent, fontSize: 12))
                                  ]))
