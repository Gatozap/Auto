...
class _ParceirosCadastrarPageState extends State<ParceirosCadastrarPage> {
  ...
  Widget build(BuildContext context) {
    BasicTimeField horaIniField = BasicTimeField(
      text: 'Hora Inicial',
      icon: FontAwesomeIcons.solidCalendarPlus,
      controller: controlerHoraIni,
    );
    BasicTimeField horaFimField = BasicTimeField(
      text: 'Hora Fim',
      icon: FontAwesomeIcons.solidCalendarPlus,
    ...
    return Scaffold(
      appBar: myAppBar(
          widget.parceiro == null ? 'Cadastrar Parceiro' : 'Editar Parceiro',
          context,
          showBack: true),
      body: Container(
    ...
    if (controllerCEP.text.isEmpty) {
                      ...
                      Padding(
                        ...
                        child: defaultCheckBox(
                            parceiro.segunda, 'Atende nas Segundas', context,
                            () {
                          parceiro.segunda = !parceiro.segunda;
                          pc.pp = parceiro;
                      ...
                      Padding(
                        padding: EdgeInsets.only(left: 40.0, bottom: 20),
                        child: defaultCheckBox(
                            parceiro.terca, 'Atende nas Terças', context, () {
                          parceiro.terca = !parceiro.terca;
                          pc.pp = parceiro;
                          pc.inParceiroSelecionado.add(pc.pp);
                        }),
                      ),
                      Padding(
                        padding: EdgeInsets.only(left: 40.0, bottom: 20),
                        child: defaultCheckBox(
                            parceiro.quarta, 'Atende nas Quartas', context, () {
                          parceiro.quarta = !parceiro.quarta;
                          pc.pp = parceiro;
                          pc.inParceiroSelecionado.add(pc.pp);
                        }),
                      ),
                      Padding(
                        padding: EdgeInsets.only(left: 40.0, bottom: 20),
                        child: defaultCheckBox(
                            parceiro.quinta, 'Atende nas Quintas', context, () {
                          parceiro.quinta = !parceiro.quinta;
                          pc.pp = parceiro;
                          pc.inParceiroSelecionado.add(pc.pp);
                        }),
                      ),
                      Padding(
                        padding: EdgeInsets.only(left: 40.0, bottom: 20),
                        child: defaultCheckBox(
                            parceiro.sexta, 'Atende nas Sextas', context, () {
                          parceiro.sexta = !parceiro.sexta;
                          pc.pp = parceiro;
                          pc.inParceiroSelecionado.add(pc.pp);
                        }),
                      ),
                      Padding(
                        padding: EdgeInsets.only(left: 40.0, bottom: 20),
                        child: defaultCheckBox(
                            parceiro.sabado, 'Atende nos Sábados', context, () {
                          parceiro.sabado = !parceiro.sabado;
                          pc.pp = parceiro;
                          pc.inParceiroSelecionado.add(pc.pp);
                        }),
                      ),
                      Padding(
                        padding: EdgeInsets.only(left: 40.0, bottom: 20),
                        child: defaultCheckBox(
                            parceiro.domingo, 'Atende nos Domingos', context,
                            () {
                          parceiro.domingo = !parceiro.domingo;
                          pc.pp = parceiro;
                          pc.inParceiroSelecionado.add(pc.pp);
                        }),
                      ),
                      ...
                      Divider(color: corPrimaria),
                      sb,
                      hText('Hora de funcionamento', context),
                      sb,
                      Divider(color: corPrimaria),
                      sb,
                      /* DefaultField(
                      ...
                      MaterialButton(
                        child: Padding(
                          ...
                          child: hText(
                              widget.parceiro == null ? 'Cadastrar' : 'Editar',
                              context,
                              color: corPrimaria,
                        ...
                        onPressed: () async {
                          ...
                          print(
                              'aqui controler hora ini ${controlerHoraIni.text}');
                          parceiro.hora_ini = TimeOfDay(
                              hour: int.parse(
                                  controlerHoraIni.text.split(":")[0]),
                              minute: int.parse(
                                  controlerHoraIni.text.split(":")[1]));

                          parceiro.hora_fim = TimeOfDay(
                              hour: int.parse(
                                  controlerHoraFim.text.split(":")[0]),
                              minute: int.parse(
                                  controlerHoraFim.text.split(":")[1]));
                          ...
                          widget.parceiro == null
                              ? parceirosRef.add(parceiro.toJson()).then((v) {
                                  ...
                                  parceirosRef
                                      ...
                                      .updateData(parceiro.toJson())
                                      .then((v) {
                                    dToast('Parceiro Criado com sucesso');
                                  });
                                  Navigator.of(context).pop();
                                })
                              : pc.EditarParceiro(parceiro).then((v) {
                                  dToast('Parceiro editado com sucesso!');
                                  Navigator.of(context).pop();
                                });
                        },
                      )
