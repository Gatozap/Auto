...
class AddEndereco extends StatefulWidget {
  ...
  bool isPrestador;
  Prestador prestador;
  AddEndereco(this.ue, {this.isPrestador, this.prestador});

  @override
  _AddEnderecoState createState() {
    return _AddEnderecoState(ue, isPrestador, prestador);
  }
}
...
class _AddEnderecoState extends State<AddEndereco> {
  ...
  _AddEnderecoState(this.ue, this.isPrestador, this.prestador);

  AddEnderecoController aec;

  @override
  Widget build(BuildContext context) {
    print("AQUI A PORRA DO ENDEREÇO ${ue.toString()}");
    if (aec == null) {
    ...
    return Scaffold(
        ...
        body: SSB(
            error: Container(
                child: buildEnderecoForm(ue != null ? ue : null, aec, context)),
            stream: aec.outEndereco,
            buildfunction: (BuildContext context, snapshot) {
              if (snapshot.data != null) {
                return Container(
                  //TODO TIRAR MOCK USER
                ...
                return Container(
                    child: buildEnderecoForm(ue , aec, context));
              }
            }));
  }
              ...
              MaterialButton(
                  onPressed: () {
                    ...
                    if (_formKey.currentState.validate()) {
                      if (isPrestador != null) {
                        if (isPrestador) {
                          aec.CadastrarCoach(controllerNumero.text, prestador);
                        } else {
                          print('ENTROU AQUI');
...
class EnderecoWidget{
  ...
  EnderecoWidget(this.ue, this.isPrestador, this.prestador);
